    ...
    endpoints: (builder) => ({
        ...
        getUserPermissions: builder.query({
            ...
            onQueryStarted: async (arg, { queryFulfilled }) => {
                try {
                    ...
                    const permissions = data.permissions || data.data?.permissions || data || [];
                    console.log('✅ User permissions fetched from API:', permissions);
        ...
        getUserRoles: builder.query({
            ...
            onQueryStarted: async (arg, { queryFulfilled }) => {
                try {
                    const { data } = await queryFulfilled;
                    const roles = data.roles || data.data?.roles || data || [];
