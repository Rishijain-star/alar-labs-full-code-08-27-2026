...
function mapLabDetailPayload(payload) {
  ...
  const detail = {
    ...
    currency: resolveItemCurrency(payload),
  ...
  const handleHeroPrimary = useCallback(async () => {
    ...
    if (groupLabData.isFree) {
      try {
        ...
        showError("Enrollment failed", err?.data?.message || err?.message || "Could not enroll in free lab.");
      }
      return;
    }
            ...
            <div className="grid lg:grid-cols-12 gap-8">
              <div className="lg:col-span-8">
                <div className="flex flex-wrap items-center gap-3 mb-4">
                  ...
                  <PlatformBadge platform={groupLabData.platform} />
                ...
                {(() => {
                  const html = sanitizeCourseDescriptionHtml(
                    pickCourseDescriptionHtml(groupLabData) ||
                      groupLabData.shortDescription ||
