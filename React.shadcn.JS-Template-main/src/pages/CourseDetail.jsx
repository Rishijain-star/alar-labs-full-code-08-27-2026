  ...
  const handleHeroPrimary = useCallback(async () => {
    ...
    if (groupLabData.isFree) {
      try {
        ...
        showError("Enrollment failed", err?.data?.message || err?.message || "Could not enroll in free course.");
      }
      return;
    }
    ...
    try {
      await checkoutCoursePayment({
        courseId: groupLabData.id,
        courseTitle: groupLabData.title,
      ...
      if (err?.message !== "Payment cancelled") {
        showError("Payment error", err?.message || "Payment failed.");
      }
    }
  }, [
    groupLabData?.id,
            ...
            <div className="grid lg:grid-cols-10 gap-8">
              ...
              <div className="lg:col-span-7">
                <div className="flex items-center gap-3 mb-4">
                  <PriceBadge isFree={groupLabData.isFree} price={groupLabData.price} currency={groupLabData.currency} />
                        ...
                        <div className="text-center">
                          <div className="flex items-baseline justify-center gap-2">
                            ...
                            <span className="text-3xl font-bold text-foreground">
                              {formatPrice(groupLabData.price, groupLabData.currency)}
                            </span>
                          </div>
            ...
            <div className="relative">
              <div className="absolute inset-0 backdrop-blur-sm bg-background/80 z-10 flex items-center justify-center rounded-xl">
                <div className="text-center p-8">
                  ...
                  <Button variant="premium" size="lg" onClick={handleHeroPrimary} disabled={enrolling || isApprovalPreview}>
                    Unlock for {formatPrice(groupLabData.price, groupLabData.currency)}
                  </Button>
                </div>
              </div>
