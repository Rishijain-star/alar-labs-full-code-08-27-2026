...
export const userApi = createApi({
    ...
    tagTypes: ["User", "Users", "MFAStatus", "DashboardStats"],
    ...
    endpoints: (builder) => ({
        ...
        getUserCreatorActivity: builder.query({
            query: (userId) => ({
                url: `/owner/users/${userId}/creator-activity`,
                method: "GET",
                meta: { withCredentials: true, showToast: false },
            }),
            providesTags: (result, error, userId) => [{ type: "Users", id: `${userId}-activity` }],
            keepUnusedDataFor: 120,
        }),

        getOwnerUserById: builder.query({
            query: (userId) => ({
                url: `/owner/user/${userId}`,
                method: "GET",
                meta: { withCredentials: true, showToast: false },
            }),
            providesTags: (result, error, userId) => [{ type: "Users", id: userId }],
