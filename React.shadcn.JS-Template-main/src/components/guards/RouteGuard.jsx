...
import { canAccessDigitalProgramsAdmin } from "@/lib/digitalProgramsPermissions";
...
export const RouteGuard = ({ 
    ...
    adminOnlyDigitalPrograms = false,
}) => {
    ...
    useEffect(() => {
        ...
        try {
            ...
            const isApprovalPerm = permissions.some((p) => String(p).startsWith("approve_"));

            if (isStudentUser && isApprovalPerm) {
                hasRouteAccess = false;
            } else if (adminOnlyDigitalPrograms) {
                hasRouteAccess = canAccessDigitalProgramsAdmin();
            } else if (route && route.permissions) {
