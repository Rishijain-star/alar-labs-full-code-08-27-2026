...
/** Redirect /app/courses/* index to mine or others based on create permission */
export function CoursesListRedirect() {
  const target = hasPermission("create_courses") ? "/app/courses/mine" : "/app/courses/others";
  return <Navigate to={target} replace />;
}

/** Redirect /app/labs index to mine or others based on create permission */
export function LabsListRedirect() {
  const target = hasPermission("create_labs") ? "/app/labs/mine" : "/app/labs/others";
  return <Navigate to={target} replace />;
}
