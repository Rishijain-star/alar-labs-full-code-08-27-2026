...
export function SiteTopBar({ visible, text, imageUrl, dismiss }) {
  ...
  return (
    <div
      className={cn(
        "fixed top-0 left-0 right-0 z-[60] h-10 border-b border-orange-600",
        "bg-orange-500 text-white text-sm shadow-sm"
      )}
    >
      <div className="h-full max-w-7xl mx-auto w-full min-w-0 px-4 sm:px-6 lg:px-8 flex items-center gap-3">
